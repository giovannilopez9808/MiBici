...
Con el conteo de números de viajes, se realizo el calculo de su promedio usando la ecuación \ref{eq:hourly_mean}. La distribución de los datos obtenidos se representa en la figura \ref{fig:distribution_count_travel}. En donde se visualiza como es que existe una mayor frecuencia en su poco uso simultaneo y los casos en donde una gran cantidad de bicicletas estas siendo sadas simultaneamente es poco común.
